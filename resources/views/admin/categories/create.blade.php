...
@endsection
@section('content')
<form action="@if(isset($category)) {{route('category.update', $category)}} @else {{route('category.store')}} @endif" method="post" accept-charset="utf-8">
  @csrf
  @if(isset($category))
    @method('PUT')
  @endif
  <div class="form-group row">
    ...
    <div class="col-sm-12">
      ...
      <input type="text" id="txturl" name="title" class="form-control " value="{{@$category->title}}"><br>
    </div>
    <div class="col-sm-12">
